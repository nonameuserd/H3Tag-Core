...
export class PeerController {
  ...
  ): Promise<PeerResponseDto | undefined> {
    try {
  ...
  async getPeers(): Promise<PeerResponseDto[] | undefined> {
    try {
  ...
  async removePeer(@Param('peerId') peerId: string): Promise<void | undefined> {
    try {
  ...
  async setBan(@Body() setBanDto: SetBanDto): Promise<void | undefined> {
    try {
  ...
  async listBans(): Promise<BanInfoDto[] | undefined> {
    try {
  ...
  async getBanInfo(@Param('ip') ip: string): Promise<BanInfoDto | undefined> {
    try {
  ...
  async getNetworkInfo(): Promise<NetworkInfoDto | undefined> {
    try {
  ...
  async getPeerInfo(
    @Param('peerId') peerId: string,
  ): Promise<PeerDetailedInfoDto | undefined> {
    try {
