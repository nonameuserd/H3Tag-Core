...
const controller = new transaction_controller_1.TransactionController(new transaction_service_1.TransactionService(new blockchain_service_1.BlockchainService(node), new core_1.TransactionBuilder()));
/**
 * @swagger
