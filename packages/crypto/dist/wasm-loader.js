    ...
    try {
        ...
        if (WebAssembly.instantiateStreaming) {
            try {
                ...
                console.warn(`instantiateStreaming failed for ${modulePath}: ${error instanceof Error ? error.message : error}. Falling back to ArrayBuffer approach.`);
            }
        }
        ...
        throw new Error(`Failed to load WASM module [${modulePath}]: ${error instanceof Error ? error.message : error}`);
    }
}
