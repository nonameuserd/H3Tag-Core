...
class Dilithium {
  static async initialize() {
    ...
    try {
      ...
      await _1.QuantumCrypto.nativeQuantum.setSecurityLevel(
  ...
  static async sign(message, privateKey) {
    ...
    try {
      ...
      const signature = await _1.QuantumCrypto.nativeQuantum.dilithiumSign(
        messageBuffer,
        privateKeyBuffer,
      );
  ...
  static async verify(message, signature, publicKey) {
    ...
    try {
      ...
      return await _1.QuantumCrypto.nativeQuantum.dilithiumVerify(
        messageBuffer,
        signatureBuffer,
        publicKeyBuffer,
      );
