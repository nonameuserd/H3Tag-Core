...
class HashUtils {
  ...
  static sha3(data) {
    try {
      ...
      throw new Error(
        `SHA3 hashing failed: ${error instanceof Error ? error.message : 'Unknown error'}`,
      );
    }
  }
  /**
  ...
  static sha256(data) {
    try {
      ...
      throw new Error(
        `SHA256 hashing failed: ${error instanceof Error ? error.message : 'Unknown error'}`,
      );
    }
  }
  /**
  ...
  static ripemd160(data) {
    try {
      ...
      throw new Error(
        `RIPEMD160 hashing failed: ${error instanceof Error ? error.message : 'Unknown error'}`,
      );
    }
  }
  /**
  ...
  static sha3Buffer(data) {
    try {
      ...
      throw new Error(
        `SHA3 buffer hashing failed: ${error instanceof Error ? error.message : 'Unknown error'}`,
      );
    }
  }
  /**
  ...
  static async calculateHash(data) {
    try {
      ...
      const classicHash = (0, crypto_1.createHash)('sha256')
        .update(content)
        .digest('hex');
      ...
      throw new Error(
        `Hybrid hash calculation failed: ${error instanceof Error ? error.message : 'Unknown error'}`,
      );
    }
  }
  /**
  ...
  static doubleSha256(data) {
    try {
      ...
      throw new Error(
        `Double SHA256 hashing failed: ${error instanceof Error ? error.message : 'Unknown error'}`,
      );
    }
  }
  /**
  ...
  static hash160(data) {
    try {
      ...
      throw new Error(
        `Hash160 calculation failed: ${error instanceof Error ? error.message : 'Unknown error'}`,
      );
    }
  }
  /**
  ...
  static toBase58(data) {
    try {
      ...
      throw new Error(
        `Base58 encoding failed: ${error instanceof Error ? error.message : 'Unknown error'}`,
      );
    }
  }
}
