export const BLOCKCHAIN_CONSTANTS = {
  ...
  MINING: {
    ...
    MAX_HALVINGS: 69,
    BLOCK_TIME: 300000,
    MAX_BLOCK_TIME: 300000,
    MAX_DIFFICULTY: 1000000,
    TARGET_TIME_PER_BLOCK: 300000,
    DIFFICULTY: 7,
    MIN_HASHRATE: 1000000,
    MAX_PROPAGATION_WINDOW: 10000,
    MIN_POW_NODES: 3,
    MAX_FORK_DEPTH: 100,
    ...
    BLOCK_REWARD: BigInt(5000000000),
    MAX_TX_SIZE: 1048576,
    MIN_FEE_PER_BYTE: 1n,
  ...
  VOTING_CONSTANTS: {
    VOTING_PERIOD_BLOCKS: 105120, // ~2 years (5-minute blocks)
    VOTING_PERIOD_MS: 63072000000, // ~2 years
    PERIOD_CHECK_INTERVAL: 60000,
    MIN_POW_WORK: 10000,
    COOLDOWN_BLOCKS: 100,
    MAX_VOTES_PER_PERIOD: 100000,
    MAX_VOTES_PER_WINDOW: 5,
    MIN_ACCOUNT_AGE: 10080, // ~1 week (5-minute blocks)
    MIN_PEER_COUNT: 3,
  ...
  CONSENSUS: {
    ...
    VOTING_PERIOD: 105120, // ~2 years (5-minute blocks)
    MIN_PARTICIPATION: 0.1,
    VOTE_POWER_CAP: 0.05,
    VOTING_DAY_PERIOD: 345 * 24 * 60 * 60 * 1000,
  ...
  TRANSACTION: {
    ...
    MAX_BLOCK_SIZE: 2097152, // Changed from 1 MB to 2 MB (increased capacity)
    MAX_TX_SIZE: 2097152, // Align with MAX_BLOCK_SIZE
  },
